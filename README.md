...
- `encore-tool/`で、Proofolio Encoreの1つだけの入力窓、AIナレッジコーチによる対話、Personal Knowledge Note、経験資産、LinkedIn経歴インポート、Facebook人脈インポート、証跡、役割候補、Innovation Seed化、ハイスペックエージェント向け応募JSON生成を試せます。
